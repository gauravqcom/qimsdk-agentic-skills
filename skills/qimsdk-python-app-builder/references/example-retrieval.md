...
- If the leveraged cached file carries a copyright/SPDX header, remove it from the final artifact — that header belongs to the cache entry, not to the generated output.
